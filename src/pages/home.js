    ...
    return(
        <div style={css.page}>
            ...
            <div style={css.main} onTouchStart={()=>{
                ...
                setIsMenu(false)}}>
                <div style={css.body}>
                    <h1 style={css.contenthead}>MyAutoLog</h1>
                    <Showcase/>
                    <h1 style={css.contenthead}>Goals</h1>
                    <div id='h_goalsdiv' style={css.goalsdiv}>
                        <div id='h_goal' style={css.goaldiv}>
                            <h2>Quality</h2>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                                incididunt ut labore et dolore magna aliqua. Lectus mauris ultrices eros in cursus.
                    ...
                    <div style={css.contentseperator}></div>
                    <h1 style={css.contenthead}>Under the Hood</h1>
